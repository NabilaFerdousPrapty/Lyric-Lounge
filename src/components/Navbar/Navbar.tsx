...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="border-b-1 relative z-20 w-full border-b  shadow-lg shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full   lg:backdrop-blur-sm lg:after:hidden">
